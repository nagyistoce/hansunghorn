...
{    
    self->luanchOption = launchOptions;
    self.window = [[[UIWindow alloc] initWithFrame:[[UIScreen mainScreen] bounds]] autorelease];
    
    SODViewController *rootView = [[SODViewController alloc] initWithNibName:@"SODMainView" bundle:nil];
...
{
    singleTon = [SharedObject sharedObject];
    [singleTon setConnectInstance:msg];
    NSURL* url = [luanchOption objectForKey:UIApplicationLaunchOptionsURLKey];
    if (url && [url isKindOfClass:[NSURL class]]) {
        self.invokeString = [url absoluteString];
		NSLog(@"CordovaTest2 launchOptions = %@", url);
    }    
