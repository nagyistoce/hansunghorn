...
{	
	...
	public void loadSounds()	// sound 包府
	{
	...
	public void makeImageInfoAll()	// image 包府
	{
	...
	public void playCommand()
	{
		if( m_gMain.m_cmd.isRegistCommand() )
		{
			...
			if( nID == GameCommand.id_send_first_card_to_you )
			{
				m_gMain.sendFirstCardToCom();
			}
			else if( nID == GameCommand.id_send_second_card_to_you )
			{
