...
public class Animation
{
	...
	public static final int id_send_first_card_to_you = 100;	// Ã³À½ ÆÐ¸¦ ³ª´²ÁÜ À§ 5Àå(³Ê)
	public static final int id_send_second_card_to_you = 200;	// Ã³À½ ÆÐ¸¦ ³ª´²ÁÜ ¾Æ·¡ 5Àå(³Ê)

	public static final int id_send_first_card_to_me = 300;		// Ã³À½ ÆÐ¸¦ ³ª´²ÁÜ À§ 5Àå(³ª)
	public static final int id_send_second_card_to_me = 400;	// Ã³À½ ÆÐ¸¦ ³ª´²ÁÜ À§ 5Àå(³ª¤Ã

	public static final int id_send_first_card_to_board = 500;	// Ã³À½ ¹Ù´ÚÆÐ 4Àå
	public static final int id_send_second_card_to_board = 600;	// Ã³À½ ¹Ù´ÚÆÐ 4Àå

	public static final int id_send_mycard_to_board = 700;		// ¹Ù´Ú¿¡¼­ ³» ¸ÔÀºÆÐ·Î..
	public static final int id_backcard_to_board = 800;			// Ä«µåµ¦¿¡¼­ ¹Ù´ÚÀ¸·Î..
	public static final int id_send_youcard_to_board = 900;		// ¹Ù´Ú¿¡¼­ ³Ê ¸ÔÀºÆÐ·Î..
	...
	public static final int id_dummy_you_turn = 1030;
