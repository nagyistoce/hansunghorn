...
public class SG
{
	...
	private static int Size_flag = 0;
	GameMain	m_pMain;
	...
	{		
		...
		Log.e("Size", ""+m_def.MobileWidth);	// 갤플 480
		Log.e("Size", ""+m_def.MobileHeight);	// 갤플 800

		if( m_def.MobileWidth== 1920 && m_def.MobileHeight==1080){
			m_def.MobileWidth = 800;
			m_def.MobileHeight = 500;
			Size_flag =1;
		}
		...
		m_gl.glOrthox( Def.FixedFromInt(-m_def.MobileWidth/2), Def.FixedFromInt(m_def.MobileWidth/2), 
				Def.FixedFromInt(-m_def.MobileHeight/2), Def.FixedFromInt(m_def.MobileHeight/2),
