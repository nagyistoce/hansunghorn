    ...
    if([CLLocationManager locationServicesEnabled] == NO){
        ...
        for(int i = 0; i < 5; i++)
        {
            ...
            if(i == 0){
                ...
                rLatitude = ((rand()%1500 + 3757080) * 0.00001);
                rLongitude = ((rand()%1500 + 12699882) * 0.00001);
            }
        ...
        for(int i = 0; i < [arrayLatitude count]; i++)
        {
            ...
            ann.title = [NSString stringWithFormat:@"스마트TV %d", i];
            ann.subtitle = [NSString stringWithFormat:@"제공 서비스 : testService"];
            ann.phone = [NSString stringWithFormat:@"전화번호 : 010-1234-5678"];
            ann.email = [NSString stringWithFormat:@"Email : SOD@hansung.ac.kr"];
